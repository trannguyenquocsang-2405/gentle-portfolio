...
export default function HomeClient({ initialData }: { initialData: any }) {
  ...
  const resumes = initialData?.resumes || [];
      ...
      <section id="blog" className="space-y-8 scroll-mt-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array.isArray(blogs) && blogs.length > 0 ? blogs.map(blog => (
            <Link key={blog.id} href={`/blog/${blog.id}`} className="block bg-white dark:bg-[#1E1E1E] p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-[#E5E5E5] dark:border-[#333333] group">
